    ...
    <div className='flex flex-col justify-center items-center p-4 m-4 mt-6 sm:m-8'>
        ...
        >
          ...
          <div className='grid grid-cols-2 sm:grid-cols-2 gap-4 sm:gap-6 justify-center items-center p-6 sm:p-16 bg-transparent lg:flex'>
            {price.map((e) => (
              <Link to={'/ProductList/'} className='mt-1 rounded shadow-2xl'>
                <div className='text-bold text-white text-lg sm:text-2xl flex justify-center items-center h-24 sm:h-28 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 shadow-xl shadow-slate-500'>
